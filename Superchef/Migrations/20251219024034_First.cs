        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountTypeId = table.Column<int>(type: "int", precision: 15, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceOS = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DeviceType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DeviceBrowser = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Banner = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SlotMaxOrders = table.Column<int>(type: "int", nullable: false),
                    StripeAccountId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    HasPublishedFirstSlots = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Verifications_Devices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateTable(
                name: "SlotTemplateStore",
                columns: table => new
                {
                    SlotTemplatesId = table.Column<int>(type: "int", nullable: false),
                    StoresId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlotTemplateStore", x => new { x.SlotTemplatesId, x.StoresId });
                    table.ForeignKey(
                        name: "FK_SlotTemplateStore_SlotTemplates_SlotTemplatesId",
                        column: x => x.SlotTemplatesId,
                        principalTable: "SlotTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SlotTemplateStore_Stores_StoresId",
                        column: x => x.StoresId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favourites", x => new { x.ItemId, x.AccountId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemKeyword_Items_ItemsId",
                        column: x => x.ItemsId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemKeyword_Keywords_KeywordsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.AccountId, x.ItemId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Carts", x => new { x.VariantId, x.AccountId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayoutTransferId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsPayoutFinished = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Slots_StoreId",
                table: "Slots",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_SlotTemplateStore_StoresId",
                table: "SlotTemplateStore",
                column: "StoresId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Verifications_DeviceId",
                table: "Verifications",
                column: "DeviceId",
                unique: true,
